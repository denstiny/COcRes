...
;	test.c:5: uchar tab[8] = {0x01,0x02,0x04,0x08,0x10,0x20,0x40,0x80};
	mov	_tab,#0x01
...
_Delay:
	...
	mov	r6,dpl
	mov	r7,dph
;	test.c:9: for(i=xms;i>0;i--)
00106$:
	mov	a,r6
	orl	a,r7
	jz	00108$
;	test.c:10: for(j=110;j>0;j--);
	mov	r4,#0x6e
	mov	r5,#0x00
00104$:
	mov	a,r4
